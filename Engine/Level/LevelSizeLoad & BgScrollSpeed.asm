...
LevelSizeArray:
		; GHZ
		dc.w $0004, $0000, $2500, $0000, $0300, $0060
...
; ---------------------------------------------------------------------------
EndingStLocArray:
		include	"Data\Levels\StartPositions\Credits.asm"
...
; ---------------------------------------------------------------------------
StartLocArray:	include	"Data\Levels\StartPositions\Levels.asm"
