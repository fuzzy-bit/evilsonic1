...
namespace S1ObjectDefinitions.GHZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Data/Art/Nemesis/GHZ Giant Ball.bin", CompressionType.Nemesis), "../Data/Mappings/Objects/GHZ Ball.asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Data/Art/Nemesis/GHZ Swinging Platform.bin", CompressionType.Nemesis), "../Data/Mappings/Objects/Swinging Platforms (GHZ).asm", labels[i], i == 1 ? 0 : 2));
		}
