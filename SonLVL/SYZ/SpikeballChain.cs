...
namespace S1ObjectDefinitions.SYZ
{
	class SpikeballChain : ObjectDefinition
	{
		...
		{
			img = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Data/Art/Nemesis/SYZ Small Spikeball.bin", CompressionType.Nemesis), "../Data/Mappings/Objects/Spiked Ball and Chain (SYZ).asm", 0, 0);
		}
