...
namespace S1ObjectDefinitions.SYZ
{
	class BigSpikedBall : ObjectDefinition
	{
		...
		{
			img = (ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../Data/Art/Nemesis/SYZ Large Spikeball.bin", CompressionType.Nemesis), "../Data/Mappings/Objects/Big Spiked Ball.asm", 0, 0));
		}
