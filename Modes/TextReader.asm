...
TextReader_Test:
	...
	move.w	#6,(Script_FirstLine).l
;	moveq	#24,d2		; number of characters to be rendered in a line -1	
	bra.w	RenderLongScript
; ===========================================================================

TextData_Test:
	dc.b	"VICTIM #1. EYEBALLS WERE UNABLE TO BE FOUND.",$A
	dc.b	"THE VICTIM WAS FOUND LYING ON HER CARPET.",$A
	dc.b	"CAUSES OF DEATH UNKNOWN, HANDMARKS WITH",$A
	dc.b	"UNIDENTIFIABLE FINGERPRINTS WERE FOUND",$A
	dc.b	"ALL OVER THE CORPSE.",$A
	dc.b	"VICTIM #1. EYEBALLS WERE UNABLE TO BE FOUND.",$A
	dc.b	"THE VICTIM WAS FOUND LYING ON HER CARPET.",$A
	dc.b	"CAUSES OF DEATH UNKNOWN, HANDMARKS WITH",$A
	dc.b	"UNIDENTIFIABLE FINGERPRINTS WERE FOUND",$A
