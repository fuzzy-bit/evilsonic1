...
; ---------------------------------------------------------------------------
LGrass_Data1:	incbin	"Data\Miscellaneous\mz_pfm1.bin"
		even
LGrass_Data2:	incbin	"Data\Miscellaneous\mz_pfm2.bin"
		even
LGrass_Data3:	incbin	"Data\Miscellaneous\mz_pfm3.bin"
		even
